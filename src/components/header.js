        ...
        <div className="navbar_right">
            <div className="navbar">
                {/* <div className="search">
                    <svg className="searchIcon" xmlns="http://www.w3.org/2000/svg" width="27.922" height="28.8" viewBox="0 0 27.922 28.8">
                    ...
                    <input className="prout" type="text" placeholder="Recherche"/>
                </div>  */}
